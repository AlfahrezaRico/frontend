                ...
                <TableBody>
                  {paged.map((rec: any) => (
                    <TableRow key={rec.id}>
                      ...
                      <TableCell>{formatTimeToString(rec.check_in_time)}</TableCell>
                      <TableCell>{formatTimeToString(rec.check_out_time)}</TableCell>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="rounded-lg border p-3">
                  ...
                  <div className="font-medium">{formatTimeToString(detailRecord.check_in_time)}</div>
                </div>
                <div className="rounded-lg border p-3">
                  <div className="text-slate-500">Jam Keluar</div>
                  <div className="font-medium">{formatTimeToString(detailRecord.check_out_time)}</div>
                </div>
                <div className="rounded-lg border p-3">
